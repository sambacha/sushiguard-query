...
__export(src_exports, {
  ...
  isOverridesObject: () => isOverridesObject,
  isTransactionFailedError: () => isTransactionFailedError,
  isTransactionReplacedError: () => isTransactionReplacedError,
  matchReadCallQuery: () => matchReadCallQuery
});
module.exports = __toCommonJS(src_exports);

// src/base/TransactionError.ts
var import_logger = require("@ethersproject/logger");
function isTransactionReplacedError(error) {
  if (error.code === import_logger.Logger.errors.TRANSACTION_REPLACED) {
    return true;
  }
  return false;
}
function isTransactionFailedError(error) {
  var _a;
  if ((_a = error == null ? void 0 : error.message) == null ? void 0 : _a.includes("-32000")) {
    return true;
  }
  return false;
}
...
function isOverridesObject(obj) {
  if ((0, import_lodash.default)(obj)) {
    const overrides = obj;
...
// src/utils/mathCallQuery/index.ts
var import_lodash2 = __toESM(require_lodash2());

// src/hooks/useRead/index.ts
...
function matchReadCallQuery(_events, _getEventFilter, query, contractAddress, methodName, callArgs) {
  const match = (0, import_lodash2.default)(
    query.queryKey,
